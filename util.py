...
class Util:
	...
	def getVideoPaths(self, path):
		...
		category_labels = {0:'Diving', 1:'Golf-Swing', 2:'Kicking', 3:'Lifting', 4:'Riding-Horse', 5:'Running', 6:'SkateBoarding', 7:'Swing-Bench', 8:'Swing-Side', 9:'Walking'}
		
		#list of category name for each folder
		category_folders = {'Diving-Side':0, 'Golf-Swing-Back':1, 'Golf-Swing-Front':1, 'Golf-Swing-Side':1, 'Kicking-Front':2, 'Kicking-Side':2, 'Lifting':3, 'Riding-Horse':4, 'Run-Side':5, 'SkateBoarding-Front':6, 'Swing-Bench':7, 'Swing-SideAngle':8, 'Walk-Front':9}
